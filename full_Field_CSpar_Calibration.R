...
K_eta = as.matrix(fread(paste("outputs/basis_",in_file,"_uw.csv", sep = "")))
...
# If this doesn't work implement with if statement with the commented code working
# for q_y = 1, and just using rep otherwise
...
emulator_parameters = c(as.matrix(read.table(paste("outputs/emulator_modes_",in_file,"_uw.csv", sep=""), sep = ",", header = TRUE)))
