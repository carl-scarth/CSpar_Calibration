...
// Simplified Version with single set of parameters for the model discrepancy
...
model {
  ...
  matrix[rank_B, m*p_eta] Lsigma_uw; // Contributions from cross-covariance matrix sigma_uw, transformed to reduced-rank equivalent
  ...
  Lsigma_uw = L*append_row(rep_matrix(0,p_delta,m*p_eta),sigma_uw);
  ...
  sigma_z[1:rank_B,rank_B+1:] = Lsigma_uw;
  sigma_z[rank_B+1:,1:rank_B] = Lsigma_uw';
  ...
  // lambda_v ~ gamma(1.0, 0.0001); // Precision parameter for discrepancy, gamma (shape, rate) (Higdon)
  // lambda_v ~ gamma(1.0, 0.00000001); // Precision parameter for discrepancy, gamma (shape, rate) (Higdon)
  lambda_v ~ gamma(10.0, 0.0001); // Precision parameter for discrepancy, gamma (shape, rate) (Chong)
  // lambda_v ~ gamma(10.0, 0.000001); // Precision parameter for discrepancy, gamma (shape, rate) (Chong)
