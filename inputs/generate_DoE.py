...
inputs = [
    ...
    ['t_ply','Gaussian', 0.125, 3.0, False],   # Mean taken from past data of material used in Bath, mean chosen from Engineering judgement of a conservative but reasonable spread in values
    ...
    ['K', 'Loguniform', np.exp(5.0), np.exp(11.5), True]
