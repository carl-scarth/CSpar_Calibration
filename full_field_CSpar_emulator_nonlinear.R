...
in_file = "LHSDesign60x6_4" # File identifier string for input and output files
...
XT_pred = fread("inputs/LHSDesign60x6_5")
...
outlist = standardise_vector_output(dt_simulation, q_y = q_y)
