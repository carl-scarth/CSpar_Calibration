...
K_eta = as.matrix(fread(paste("outputs/basis_nonlinear_",in_file,"_uw.csv", sep = "")))
...
emulator_parameters = c(as.matrix(read.table(paste("outputs/nonlinear_emulator_modes_",in_file,"_uW.csv", sep=""), sep = ",", header = TRUE)))
