...
K_eta = as.matrix(fread(paste("outputs/basis_nonlinear_",in_file,"_U.csv", sep = "")))
...
emulator_parameters = c(as.matrix(read.table(paste("outputs/nonlinear_emulator_modes_",in_file,"_u.csv", sep=""), sep = ",", header = TRUE)))
if (use_subset) {
